...
const Par4Card = ({ scorecard, i, handleForm, nextHole, form }) => {
  ...
  const getIconScore = (value) => {
    ...
    else if (value === 4) return "numeric-4";
    else if (value === 5) return "numeric-5-box-outline";
    ...
    return (
      <>
        <View style={styles.iconsRow}>
          ...
          <TouchableOpacity
            onPress={() => {
              setOneScore("numeric-3-circle-outline");
          ...
          <TouchableOpacity
            onPress={() => {
              setOneScore("numeric-5-box-outline");
