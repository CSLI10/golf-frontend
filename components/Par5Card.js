...
const Par5Card = ({ scorecard, i, handleForm, nextHole, form }) => {
  ...
  const getIconScore = (value) => {
    ...
    else if(value === 2) return "numeric-2-circle";
    else if(value === 3) return "numeric-3-circle";
    else if(value === 4) return "numeric-4-circle-outline";
    else if(value === 5) return "numeric-5";
    else if(value === 6) return "numeric-6-box-outline";
  ...
  const ShowScores = () => { 
    ...
    return(
      ...
      <View style={styles.iconsRow}> 
          ...
          <TouchableOpacity onPress={() => {setOneScore("numeric-3-circle"); handleForm("score", i, 3)}}>
              <MaterialCommunityIcons name="numeric-3-circle" size={50} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {setOneScore("numeric-4-circle-outline"); handleForm("score", i, 4)}}>
              <MaterialCommunityIcons name="numeric-4-circle-outline" size={50} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {setOneScore("numeric-5"); handleForm("score", i, 5)}}>
              <MaterialCommunityIcons name="numeric-5" size={50} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {setOneScore("numeric-6-box-outline"); handleForm("score", i, 6)}}>
              <MaterialCommunityIcons name="numeric-6-box-outline" size={50} color="black" />
          </TouchableOpacity>
      </View>
      <View style={styles.iconsRow}>
