  ...
  const ShowScores = () => { 
    ...
    return(
      ...
      <View style={styles.iconsRow}> 
          ...
          <TouchableOpacity onPress={() => {setOneScore("numeric-2-circle-outline"); handleForm("score", i, 2)}}>
              <MaterialCommunityIcons name="numeric-2-circle-outline" size={50} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {setOneScore("numeric-3"); handleForm("score", i, 3)}}>
              <MaterialCommunityIcons name="numeric-3" size={50} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {setOneScore("numeric-4-box-outline"); handleForm("score", i, 4)}}>
              <MaterialCommunityIcons name="numeric-4-box-outline" size={50} color="black" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => {setOneScore("numeric-5-box"); handleForm("score", i, 5)}}>
